...
public class MerchantDaySerialGenerator extends AbstractMerchantDataFileGenerator {

	private static final Logger logger = LoggerFactory.getLogger(MerchantDaySerialGenerator.class);
