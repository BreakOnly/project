...
public class PdfReplacer {
	 ...
	 * 生成新的PDF文件
	 */
	void toPdf(String fileName) throws DocumentException, IOException{
	 ...
	 * 设置字体大小
	 */
    private void setFont(int fontSize) throws DocumentException, IOException{
