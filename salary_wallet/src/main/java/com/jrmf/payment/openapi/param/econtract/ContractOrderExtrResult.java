...
public class ContractOrderExtrResult extends CommonExtrResult {
	...
	public String getPartyaSubStateDesc() {
		return (StringUtils.isBlank(this.getSubState()) || StringUtils.isBlank(this.getPartyaUserName())) ? ""
				: Constants.subStateMap.get(String.valueOf(this.getSubState().charAt(0)));
	}

	public String getPartybSubStateDesc() {
		return (StringUtils.isBlank(this.getSubState()) || StringUtils.isBlank(this.getPartybUserName())) ? ""
				: Constants.subStateMap.get(String.valueOf(this.getSubState().charAt(1)));
	}

	public String getPartycSubStateDesc() {
		return (StringUtils.isBlank(this.getSubState()) || StringUtils.isBlank(this.getPartycUserName())) ? ""
				: Constants.subStateMap.get(String.valueOf(this.getSubState().charAt(2)));
	}
